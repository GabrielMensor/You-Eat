...
const illustrativeImages = [                                 // Importa as imagens para cadastro
    require('../../assets/ProductPictures/brigadeiro.jpg'),     // 7
    require('../../assets/ProductPictures/pastel.jpg'),         // 8
    require('../../assets/ProductPictures/boloTorta1.jpg'),     // 9
    require('../../assets/ProductPictures/coxinha.jpg'),        // 16
    require('../../assets/ProductPictures/beijinho.jpg')        // 17
]

export default function ProductRegistration({ navigation: { navigate } }) {
                ...
                <ScrollView>
                    ...
                    <View style={{flexDirection: 'row', flexWrap: 'wrap'}}>
                        {illustrativeImages.map((img, i) => (
                            <TouchableOpacity key={i} onPress={() => {setImgUm(img); setModalVisibility(false)}}>
    ...
    return (
        <View style={styles.container}>
            ...
            <TextInput placeholder='Apresente uma breve descrição do produto...' style={styles.textArea} onChangeText={text => setDescricao(text)} value={descricao}></TextInput>
